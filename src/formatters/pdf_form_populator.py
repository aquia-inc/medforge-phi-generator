...
class CustomerTemplateManager:
    ...
    def __init__(self, template_dir: str = 'temp', output_dir: str = 'output'):
        ...
        self.template_mappings = {
            ...
            'CLINTemplates': {
                'template': 'saved_templates/CLIN Templates-CUI-Procurement-positive.docx',
            ...
            'MarketResearch': {
                'template': 'saved_templates/TAB D Market Research-CUI-Procurement-positive.docx',
            ...
            'RFCMemo': {
                'template': 'saved_templates/RFC Memo-CUI-Procurement-positive.docx',
            ...
            'AGXRFCMemo': {
                'template': 'saved_templates/AGX RFC Memo-CUI-Procurement-positive.docx',
            ...
            'JALimitedSource': {
                'template': 'saved_templates/JA LimitedSource-CUI-Procurement-positive.docx',
            ...
            'JOFOC': {
                'template': 'saved_templates/JOFOC-CUI-Procurement-positive.docx',
            ...
            'OAGMSourceSelection': {
                'template': 'saved_templates/OAGM SourceSelection-CUI-Procurement-positive.docx',
            ...
            'AcquisitionPlan': {
                'template': 'saved_templates/CMS AcquisitionPlan-CUI-Procurement-positive.docx',
            ...
            'KMP': {
                'template': 'saved_templates/KMP-MockSystem-CUI-Critical Infrastructure-Positive.docx',
            ...
            'RulesOfBehavior': {
                'template': 'saved_templates/2025 PQCRA Rules of Behavior - MAC NAME-CUI-Critical Infrastructure-positive.docx',
            ...
            'AFRAdditionalInfo': {
                'template': 'saved_templates/Additional Information OIT FO-Mock AFR-CUI-Budget-positive.docx',
            ...
            'DIBOAFR': {
                'template': 'saved_templates/DIBO AFR -AMI-CUI-Budget-Positive.docx',
            ...
            'SupplementalAFR': {
                'template': 'saved_templates/Supplemental AFR Information-MockProject-CUI-Budget-Positive.docx',
            ...
            'HHSRBD': {
                'template': 'saved_templates/hhs-RBD-CUI-Critical Infrastructure-positive.pdf',
            ...
            'B6Letter': {
                'template': 'saved_templates/B6 Letter-CUI-Legal-positive.docx',
            ...
            'FullRelease': {
                'template': 'saved_templates/Full Release-CUI-Legal-positive.docx',
            ...
            'Form339Letter': {
                'template': 'saved_templates/Form339 Letter-CUI-Legal-positive.docx',
            ...
            'SubpoenaResponse': {
                'template': 'saved_templates/Subpoena Response-CUI-Legal-positive.docx',
